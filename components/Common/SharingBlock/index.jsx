        ...
        <li className='flex justify-center items-center transition-opacity hover:opacity-50'>
          ...
          >
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path fillRule="evenodd" clipRule="evenodd" d="M14.0001 0.666626C6.63628 0.666626 0.666748 6.63616 0.666748 14C0.666748 21.3638 6.63628 27.3333 14.0001 27.3333C21.3639 27.3333 27.3334 21.3638 27.3334 14C27.3334 6.63616 21.3639 0.666626 14.0001 0.666626ZM11.477 22H14.4331V13.999H16.4054L16.6667 11.2419H14.4331L14.4365 9.86187C14.4365 9.14276 14.4975 8.75744 15.4198 8.75744H16.6528V5.99996H14.6803C12.3109 5.99996 11.477 7.33748 11.477 9.58678V11.2422H10.0001V13.9993H11.477V22Z" fill="white"/>
            </svg>
          </FacebookShareButton>
        </li>
        <li className='flex justify-center items-center transition-opacity hover:opacity-50'>
