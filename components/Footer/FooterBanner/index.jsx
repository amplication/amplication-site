...
const FooterBanner = () => {
  return (
    <div className='bg-purple px-4 pt-9 my-5 flex flex-col justify-start items-center rounded border border-black border-solid laptop:flex-row laptop:justify-between laptop:p-0 overflow-hidden relative'>
