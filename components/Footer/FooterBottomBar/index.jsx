...
const FooterBottomBar = () => {
  return (
    <div className="w-full flex flex-col laptop:flex-row justify-between items-center gap-4 py-8 px-4 tablet:px-16 bg-light-blue border-t border-dark-black-70 text-gray text-sm ">
      <div className="flex flex-row justify-start gap-4 items-center order-2 laptop:order-1">
        <p>{`©${new Date().getFullYear()} amplication`}</p>
        <Link href="/privacy-policy">
          <a className="text-xs  underline hover:text-purple-bright-hover">
            Privacy Policy
          </a>
        </Link>
        <Link href="/terms">
      ...
      <div className="flex flex-row justify-end items-center gap-4  order-1 laptop:order-2">
        <span>Follow us</span>
