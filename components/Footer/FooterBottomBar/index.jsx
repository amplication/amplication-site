              ...
              <Link href={process.env.NEXT_PUBLIC_TWITTER_LINK}>
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
  <path d="m9.42,6.83L14.99.36h-1.32l-4.83,5.62L4.98.36H.52l5.84,8.5L.52,15.64h1.32l5.11-5.93,4.08,5.93h4.45l-6.06-8.81h0Zm-1.81,2.1l-.59-.85L2.32,1.35h2.03l3.8,5.43.59.85,4.94,7.06h-2.03l-4.03-5.76h0Z" fill="#A3A8B8"/>                  />
                  </svg>
