  ...
  return (
    <div className="relative z-10 w-full bg-light-blue laptop:mb-[-1px]">
      <Link href={process.env.NEXT_PUBLIC_GITHUB_LINK} passHref>
        <a className="w-full flex justify-center items-center max-w-container m-container p-container py-2 cursor-pointer hover:opacity-50 transition-opacity duration-300">
          ...
          <span className="text-white text-xs leading-loose">
