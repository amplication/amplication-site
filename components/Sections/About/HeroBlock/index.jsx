              ...
              <div className="header-and-video">
                <div className="content-block flex flex-column justify-content-center mb-20 laptop:mb-0">
                  <div className="animated-header !mt-14">
                    <h1
                      className="!text-[42px] desktop:!text-[56px] text-left !leading-[56px] desktop:!leading-[72px] font-bold"
                      data-aos="fade-up"
                    >
                    ...
                    <div
                      className="explainer text-lg text-white my-2 !max-w-[628px]"
                      data-aos="fade-up"
                      data-aos-delay="200"
                    >
                  ...
                  <div
                    className="d-flex mt-4 align-items-center justify-content-center justify-content-lg-start"
                    data-aos="fade-up"
                    data-aos-delay="400"
                  >
                    <Link
