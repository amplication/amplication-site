...
const LogoList = () => {
  ...
  return (
    <>
      <section className=" border-b-[1px] border-dark-black-70 background-transparent !py-24 w-full max-w-container m-container p-container laptop:max-w-container-desktop laptop:m-container-desktop laptop:p-container-desktop">
        ...
        <div className="logotypes d-flex justify-evently align-items-center ">
