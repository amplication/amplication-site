      ...
      <>
        <section className="background-transparent w-full max-w-container m-container p-container laptop:max-w-container-desktop laptop:m-container-desktop laptop:p-container-desktop">
          ...
          <div className="d-flex">
            <div className="col-sm-4 d-flex align-items-center justify-content-center" data-aos="zoom-in">
              <Image src={LogoNorwest} alt={''} />
            </div>
            <div className="col-sm-4 d-flex align-items-center justify-content-center" data-aos="zoom-in" data-aos-delay="200">
              <Image src={LogoEntree} alt={''} />
            </div>
            <div className="col-sm-4 d-flex align-items-center justify-content-center" data-aos="zoom-in" data-aos-delay="400">
