...
const StartNow = ({
  ...
  return (
    <>
      <section className="background-transparent w-full max-w-container m-container p-container laptop:max-w-container-desktop laptop:m-container-desktop laptop:p-container-desktop !pt-10 !pb-12 desktop:!py-36">
        <h2 className="h2 tablet:text-center mx-auto !mb-10 max-w-[960px]">{title}</h2>
