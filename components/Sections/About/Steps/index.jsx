          ...
          <div className="row feature d-flex justify-content-between align-items-center !my-4 laptop:!my-12">
            <div className="col-sm-12 col-md-6 pr-3">
              ...
              >
                ...
                in any organization.
                <br />
                We believe this approach will shape the next-generation
                programming.
                <br />
                <br />
            ...
            <div className="col-sm-12 col-md-6 relative flex align-items-center pt-12 desktop:pt-0 aspect-square desktop:h-[430px]">
              <div
                className="absolute left-[17%] top-[12%] w-[65%]"
                data-aos="zoom-in"
                data-aos-delay="500"
              >
              ...
              <div
                className="absolute left-[20%] top-[2%] w-[50%] backdrop-blur-sm"
                data-aos="zoom-in"
                data-aos-delay="700"
              >
              ...
              <div
                className="absolute left-[-11%] top-[-48%] w-[134%]"
                data-aos="zoom-in"
                data-aos-delay="900"
              >
              ...
              <div
                className="absolute left-[54%] top-[21%] w-[35%]"
                data-aos="zoom-in"
                data-aos-delay="1100"
              >
