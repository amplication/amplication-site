            ...
            {facts.map((fact, i) => {
              return (
                <div className="col-sm-6 col-md-4" key={i}>
                  <div className="rounded-lg border-[1px] border-dark-black-70 h-[160px] desktop:h-[250px] flex flex-column align-items-center justify-content-center !mb-4 tablet:!mb-7 px-4">
