            ...
            <div className="col-12 text-center">
              <div className="header-and-video">
                ...
                <div className="relative !max-w-[80%] h-[66vw] mx-auto hidden medium:block laptop:!max-w-[55%] laptop:h-auto">
                  <div className="absolute flex items-center justify-center inset-y-0 left-[-6%]">
                    <svg width="1018" height="1149" viewBox="0 0 1018 1149" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="1137.5" cy="558.5" r="590" stroke="white" stroke-opacity="0.1"/>
                      <circle cx="1140" cy="586" r="276.5" stroke="white" stroke-opacity="0.1"/>
                      <path d="M364.5 565.5C163.744 565.5 1 402.756 1 202" stroke="white" stroke-opacity="0.1"/>
                      <path d="M554 527.5C554 728.256 391.256 891 190.5 891" stroke="white" stroke-opacity="0.1"/>
                    </svg>
                  </div>
