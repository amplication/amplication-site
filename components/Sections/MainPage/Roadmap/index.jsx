        ...
        <div className="w-full max-w-container m-container p-container laptop:max-w-container-desktop laptop:m-container-desktop laptop:p-container-desktop">
          <div className="row m-container p-container align-items-center mb-2 text-white">
            ...
            <p className="roadmap-paragraph">
              While we continuously work alongside our community to make
              Amplication Community Edition better,
              <br />
              we are extending its capabilities into Enterprise Edition to meet
              the requirements and standards of large-scale organizations and
              enterprises.
            </p>
          </div>
