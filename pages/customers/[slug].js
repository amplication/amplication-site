  ...
  return (
    <>
      ...
      <PageSection alternate>
        <main className="flex flex-col flex-wrap  justify-center items-center w-full  font-poppins max-medium:overflow-hidden p-container laptop:max-w-container-desktop-blog laptop:m-container-desktop laptop:p-container-desktop py-8 ">
