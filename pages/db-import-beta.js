...
const cards = [
  {
    title: 'Quick import',
    subTitle:
      'Import your existing database schema into Amplication swiftly and seamlessly.',
    icon: icon5,
  },
  {
    title: 'Modern stack',
  ...
  },
  {
    ...
    subTitle:
      'Perfect for organizations looking to update or replace their legacy systems.',
    icon: icon3,
  },
];
...
const DbImportBeta = () => {
  return (
    <>
      ...
      <main
        className="w-full font-poppins z-10 !mb-0 laptop:mb-[100px] amplication-base"
        id="apply"
      >
        <Hero />
        ...
        <StartNow
          ...
          title="Modernize your legacy systems without the hassle of remapping your entire database."
          linkSecondary={{
            href: '#apply',
            title: 'Apply now',
            target: '_self',
