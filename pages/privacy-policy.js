        ...
        <section className="pt-4 pt-md-11 home-background">
          <div className="container mx-auto">
            ...
            <div className="p-4 row d-flex justify-content-between align-items-stretch policy-content-align">
              <p>
                Amplication (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
                operates the https://amplication.com website and
              ...
              <p>
                ...
                and the choices you have associated with that data. We use your
                data to provide and improve the Service. By using the Service,
              ...
              <h3>Information Collection And Used</h3>
              <p>
              ...
              <p>
                ...
                Service. Examples of Cookies we use: Session Cookies. We use
                Session Cookies to operate our Service. Preference Cookies. We
              ...
              <h3>Use of Data</h3>
              <p>
                Amplication uses the collected data for various purposes: To
                ...
                that we can improve the Service. To monitor the usage of the
              ...
              <p>
                ...
                Amplication will take all steps reasonably necessary to ensure
              ...
              <p>
                Legal Requirements: Amplication may disclose your Personal Data
                in the good faith belief that such action is necessary to: To
                comply with a legal obligation. To protect and defend the rights
                or property of Amplication. To prevent or investigate possible
                wrongdoing in connection with the Service. To protect the
                personal safety of users of the Service or the public. To
